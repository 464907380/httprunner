# Generated by Django 2.2 on 2019-04-28 17:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dubbo_is', models.IntegerField(null=True, verbose_name='1为dubbo用例')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('belong_project', models.CharField(max_length=50, verbose_name='所属项目')),
                ('include', models.CharField(max_length=1024, null=True, verbose_name='前置config/test')),
                ('author', models.CharField(max_length=200, verbose_name='编写人员')),
                ('request', models.TextField(null=True, verbose_name='请求信息')),
                ('remark', models.CharField(max_length=100, null=True, verbose_name='备注')),
                ('dubbo_is', models.IntegerField(null=True, verbose_name='1为dubbo用例')),
                ('case_level', models.TextField(max_length=1024, verbose_name='用例级别')),
                ('case_condition', models.TextField(verbose_name='前提条件')),
                ('operating_steps', models.TextField(verbose_name='操作步骤')),
                ('expect', models.TextField(verbose_name='预期结果')),
                ('belong_module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ApiManager.ModuleInfo')),
            ],
            options={
